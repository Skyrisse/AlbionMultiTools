...
### БИЛДЫ
- Интеграция с **Albion Forge** — редактор билдов, характеристики, сравнение сетов
- Открывается в браузере в один клик; сохранённые билды остаются в localStorage браузера
