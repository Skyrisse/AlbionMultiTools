...
- **Делёжка** — список отсканированных значений серебра (можно отсканировать из сундука или инвентаря расчетную стоимость для автозаполнения), сумма и деление на N человек
